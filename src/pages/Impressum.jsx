...
const Impressum = () => {
  ...
  return (
    <Layout>
      <div className='p-20 mt-[90px]'>
        <h1 className='text-orange-900 text-2xl md:text-3xl lg:text-4xl text-center pb-5'>
          Impressum
        </h1>

        {/** Generierter Fantasietext */}
        <div className='max-w-[1400px] mx-auto border-t border-black pt-10'>
